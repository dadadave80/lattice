...
contract DeployAxelarGatewayAdapter is BaseDeploy {
    ...
    /// @return cuts The facet cuts (ERC165 + AccessControl + AxelarGatewayAdapter).
    /// @return init The {AxelarGatewayAdapterInit} initializer address.
    /// @return initCalldata The `init(admin, gateway)` calldata.
