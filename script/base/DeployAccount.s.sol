...
///         primitive tests reuse; {run} is the broadcasting deploy entrypoint. Selectors come from
///         diamond-lib {GetSelectors} (`forge inspect` over FFI), so a facet's real ABI is the source.
...
contract DeployAccount is Script, GetSelectors {
